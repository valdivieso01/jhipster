...
export class PreferencesComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    if (this.currentSearch) {
      this.preferencesService
        ...
        .subscribe(
          (res: HttpResponse<IPreferences[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
          () => this.onError()
        );
      return;
    }
  ...
  protected onSuccess(data: IPreferences[] | null, headers: HttpHeaders, page: number): void {
